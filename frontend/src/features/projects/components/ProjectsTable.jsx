...
const columns = [
  ...
  { key: "PROJECT_MANAGER_ID", label: "Manager", sortable: false },
  { key: "ACTIVE", label: "Status", sortable: true },
  { key: "BILLABLE", label: "Billing", sortable: true },
...
const SKELETON_WIDTHS = ["60%", "45%", "75%", "55%", "40%", "50%", "65%"];
    ...
    <div className="flex flex-col gap-5 font-['Circular',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif]">
      ...
      <div className="flex items-center justify-between text-sm text-[#717171]">
        <span className="text-xs">
          {resolvedTotal === 0
            ? "No results"
            : `${(page - 1) * limit + 1}–${Math.min(page * limit, resolvedTotal)} of ${resolvedTotal} projects`}
        </span>
